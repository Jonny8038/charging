<script>
	export default {
		globalData: {
			bootomTop: 0,
			isMark:true,
			imgUrl: 'https://www.xxxx.cn/statics/', //线上图片地址
			// uploadUrl: 'http://xx.xxx.xxx.x:xxxx/file/regupload',  // 上传 
			bdUrl: 'https://aip.baidubce.com/oauth/2.0/token?grant_type=client_credentials&client_id=xxxxxxxx&client_secret=xxxxxxx',//百度ocr
