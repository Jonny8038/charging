<template>
	<view class="container">
		<view class="content">
			...
			<swiper class="swiper" indicator-dots="true" circular="true" indicator-color="rgba(255, 255, 255, .28)"
						...
						<block v-for="(item,index) in lists" :key="index">
							<view class="li">
								...
								<view class="lile">
									...
									<view class="lidc">电池<text>{{item.zxnum?item.zxnum:0}}</text>
									</view>
								</view>
								<view class="liri">
									<view class="lidh">
										<text v-if="item.phone" class="iconfont icon-a-lujing426" :data-tel="item.phone"
											@click="callTel"></text>
									...
									<view class="jl font26 color9" v-if="item.distance">{{item.distance}}
									</view>
					...
					<view class="ztxx">
						<view class="ztxxle">
							...
							<view class="wzsj">
								...
								<view class="ztsj">更新时间：{{carInfo.receiveTime?carInfo.receiveTime:"''"}}</view>
							</view>
						</view>
			...
			<view class="clzt">
				...
				<view class="hdcon" v-if="lastinfo">
					...
					<view class="hddata">
						...
						<view class="hditem">电量：<text>{{lastinfo.newBatteryPower?lastinfo.newBatteryPower:0}}%</text>
						</view>
					</view>
					<view class="hdri">
				...
				<view class="hdcon hdconho" v-else>暂无</view>
			</view>
			<view class="zx">
		...
		<popup v-if="isMask" type="2" :redtitle="redtitle" :money="money" @close="closeMask()" @eventClick="eventClick">
		</popup>
	</view>
</template>
...
<script>
	...
	import popup from '../../components/ge-popup/ge-popup.vue'
