...
/* 14 */
/*!*****************************************************************!*\
  !*** E:/code/hdwechat/main.js?{"page":"pages%2Findex%2Findex"} ***!
  \*****************************************************************/
...
/* 15 */
/*!**********************************************!*\
  !*** E:/code/hdwechat/pages/index/index.vue ***!
  \**********************************************/
/*! no static exports found */
...
/* 16 */
/*!*****************************************************************************!*\
  !*** E:/code/hdwechat/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \*****************************************************************************/
...
/* 17 */
/*!*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--16-0!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/template.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/page-meta.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!E:/code/hdwechat/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns, recyclableRender, components */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 18 */
/*!***********************************************************************!*\
  !*** E:/code/hdwechat/pages/index/index.vue?vue&type=script&lang=js& ***!
  \***********************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 19 */
/*!******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!E:/code/hdwechat/pages/index/index.vue?vue&type=script&lang=js& ***!
  \******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
//
//
var popup = function popup() {__webpack_require__.e(/*! require.ensure | components/ge-popup/ge-popup */ "components/ge-popup/ge-popup").then((function () {return resolve(__webpack_require__(/*! ../../components/ge-popup/ge-popup.vue */ 240));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _default = { components: { popup: popup }, data: function data() {return { imgUrl: getApp().globalData.imgUrl, topIndex: 0, cityname: '', successState: true, failState: true, lists: [], dtDetaile: {}, sitename: '', zxList: [], lat: '', //点击列表预约获取导航数据
      lng: '', //点击列表预约获取导航数据
      dhname: '', //点击列表预约获取导航数据
      address: '', //点击列表预约获取导航数据
      banners: [], carId: '', carInfo: {}, //车辆状态
      dwqz: '', //当前为止
      lastinfo: null, gglist: [], weather: '', //------------------
      isMask: false, //是否显示弹窗
      index: 1, //显示第几个弹窗
      redtitle: '新用户注册专享', money: 99.99, //红包金额
      title: '公告', content: '公告内容公告内容公告内容公告内容公告内容公告内容公告内容公告内容公告内容公告内容公告内容公告内容公告内容公告内容公告内容', version: '1.0', desc: '1.更新内容更新内容 <br/> 2.更新内容更新内容 <br/>2.更新内容更新内容' };}, methods: { closeMask: function closeMask() {//关闭弹窗
      // console.log(111)';
      uni.setStorage({ key: 'isMark', data: false });this.isMask = false; // this.isMask = false
    }, update: function update() {console.log('更新操作');}, eventClick: function eventClick(res) {uni.setStorage({ key: 'isMark', data: false });this.isMask = false;}, // 点击切换
    menuClick: function menuClick(e) {this.topIndex = e.target.dataset.num;}, // 底部切换
    tabClick: function tabClick(e) {if (e.currentTarget.dataset.index == 0) {uni.reLaunch({ url: '../index/index' });} else if (e.currentTarget.dataset.index == 1) {uni.reLaunch({ url: '../server/server' });} else if (e.currentTarget.dataset.index == 2) {uni.reLaunch({ url: '../my/my' });}}, gomapSite: function gomapSite() {uni.navigateTo({ url: '../mapSite/mapSite' });}, gosystemInfo: function gosystemInfo() {uni.navigateTo({ url: '../systemInfo/systemInfo' });}, goFaultInfo: function goFaultInfo() {uni.navigateTo({ url: '../faultInfo/faultInfo' });}, goMycell: function goMycell() {uni.navigateTo({ url: '../cell/cell' });}, gozxList: function gozxList() {uni.navigateTo({ url: '../newsList/newsList' });}, goItemDetaile: function goItemDetaile(e) {var id = e.currentTarget.dataset.id;uni.navigateTo({ url: '../../pages/itemDetaile/itemDetaile?id=' + id });}, // 轮播
    getBanners: function getBanners() {var _this = this;this.$http.sendRequest('appsysmgs/banner/list', 'POST').then(function (res) {console.log("1111111", res);if (res.data.code == 200) {if (res.data.data.length != 0) {_this.banners = res.data.data;}} else {uni.showToast({ icon: 'none', title: res.data.msg });}}).catch(function (err) {uni.showToast({ icon: 'none', title: "网络错误" });});}, Rad: function Rad(d) {//根据经纬度判断距离
    ...
    lbyyFun: function lbyyFun(e) {//预约接口
      this.yyreserv(e.currentTarget.dataset.id);this.lat = e.currentTarget.dataset.lat;this.lng = e.currentTarget.dataset.lng;this.dhname = e.currentTarget.dataset.dhname;this.address = e.currentTarget.dataset.address;}, yyreserv: function yyreserv(id) {console.log('1111', id);var that = this;this.$http.sendRequest('/appreserv/create', 'POST', { siteId: id }).then(function (res) {console.log('res111', res); // const value = uni.getStorageSync("vin");
    ...
    getCarinfo: function getCarinfo(id) {var _this4 = this;this.$http.sendRequest('/appcar/carinfo', 'GET', { carId: id }).then(function (res) {if (res.data.code == 200) {_this4.carInfo = res.data.data;
        } else {
          uni.showToast({
            icon: 'none',
            title: res.data.msg });
...
/* 22 */
/*!*******************************************************************************!*\
  !*** E:/code/hdwechat/pages/index/index.vue?vue&type=style&index=0&lang=css& ***!
  \*******************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 23 */
/*!***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--6-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--6-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--6-oneOf-1-2!./node_modules/postcss-loader/src??ref--6-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!E:/code/hdwechat/pages/index/index.vue?vue&type=style&index=0&lang=css& ***!
  \***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
